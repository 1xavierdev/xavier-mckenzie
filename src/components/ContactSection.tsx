...
const EMAIL = "x.mckenzie@my.ccsu.edu";

const socialLinks = [
  { icon: Github, href: "https://github.com/1xavierdev", label: "GitHub" },
  { icon: Linkedin, href: "https://linkedin.com/in/xaviermckenzie", label: "LinkedIn" },
  ...
  return (
    <section id="contact" className="py-24 px-6">
      <div className="container mx-auto max-w-2xl text-center">
        <p className="kicker justify-center mb-3">06 / Contact</p>
        <h2 className="section-title text-4xl md:text-5xl mb-6">Let's build something</h2>
        <p className="text-muted-foreground text-lg leading-relaxed mb-10">
          I'm currently a Software Engineering Intern at CGI and always open to connecting about
          software engineering, cloud, and AI. If you have an opportunity, want to collaborate, or
